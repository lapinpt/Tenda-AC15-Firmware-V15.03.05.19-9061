...
var moduleModel = R.moduleModel({
	...
	getSubmitData: function () {
		return "WifiAntijamEn=" + $("#interference").val();
	}
});
...
function initHtml(str) {
	if (str == "true") {
		$("#interference").attr("class", "btn-on");
		$("#interference").val("true");
	} else {
		$("#interference").attr("class", "btn-off");
		$("#interference").val("false");
	}
}

function initEvent() {
	$("#interference").on("click", function () {
