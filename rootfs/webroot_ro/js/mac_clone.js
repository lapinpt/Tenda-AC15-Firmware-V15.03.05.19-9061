...
var moduleModel = R.moduleModel({
	...
	getSubmitData: function () {
		...
		data += "&wanServerName="+$("#wanServerName").val();
		data += "&wanServiceName="+$("#wanServiceName").val();
		if (G.wanNum == 2) {
			if ($("#cloneType2").val() == "0") {
...
function initValue(obj) {
	...
	$("#wanServerName").val(obj.wanInfo[0].wanServerName);
	$("#wanServiceName").val(obj.wanInfo[0].wanServiceName);
