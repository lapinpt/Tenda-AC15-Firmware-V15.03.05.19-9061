...
function getMoreFolder(folderId, subData) {
    ...
    if ($("#" + folderId).html() !== "") {
        ...
        //显示搜索图标
        $(".folder-scan").css("background", "url(/img/scan.gif?67b4b7e83ba9f7abdb605ceb277b8ece) 0 no-repeat");
