...
function changeImg(imgID, powerValue) {
    ...
    if (powerValue == "low") {
        $imgDom.attr("src", "../img/icon-power-gray1.png?67b4b7e83ba9f7abdb605ceb277b8ece");
    } else if (powerValue == "middle") {
        $imgDom.attr("src", "../img/icon-power-gray2.png?67b4b7e83ba9f7abdb605ceb277b8ece");
    } else {
        $imgDom.attr("src", "../img/icon-power.png?67b4b7e83ba9f7abdb605ceb277b8ece");
    }
}
